  ...
  return (
    <div className="flex flex-col justify-center h-full px-8 pb-20">
      <div className="animate-slide-up">
        <h2 className="text-7xl md:text-8xl font-serif font-bold tracking-tighter leading-[0.85] mb-10 whitespace-pre-line bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/50">
          {content.title}
        </h2>
        <div className="w-16 h-1 bg-white/30 mb-10 rounded-full"></div>
        <p className="text-xl md:text-2xl font-normal font-sans text-white/90 leading-relaxed mb-16 max-w-[95%] tracking-tight">
          {content.subtitle}
        </p>
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full pl-5 pr-2 py-2 cursor-pointer hover:bg-white/20 transition-colors">
          <span className="text-sm font-semibold tracking-wide uppercase font-sans">{content.tag}</span>
